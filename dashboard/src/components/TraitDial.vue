...
<template>
  <label class="gauge">
    <span class="trait-heading"><span class="gl">{{ label }}</span><span class="trait-value"><span class="gw">{{ word }}</span><span class="gv">{{ value }}</span></span></span>
...
.trait-value { display:flex; align-items:baseline; gap:6px; min-width:0; text-align:right; }
