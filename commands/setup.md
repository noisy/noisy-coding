---
description: Start the Noisy Studio voice backend (Docker) and walk through first-time setup
---
...
Set up the Noisy Studio voice backend for this user. Follow these steps in order and narrate briefly as you go:
